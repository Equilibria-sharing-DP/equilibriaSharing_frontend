...
const SelectTrigger = React.forwardRef<
  ...
  error?: boolean;
  placeholder?: string; // Optionaler Prop für den Platzhalter
  value?: string; // Wert aus dem Select
}
>(({ className, error, placeholder, value, children, ...props }, ref) => (
    <SelectPrimitive.Trigger
        ...
        className={cn(
            ...
            error
                ? "border-red-500 dark:border-red-400 bg-red-50 dark:bg-red-900 focus-visible:ring-red-500 dark:focus-visible:ring-red-400"
